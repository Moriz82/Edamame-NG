...
```powershell
$testSid = (Get-LocalUser 'edamame_lab').SID.Value
powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\tests\fixtures\windows\WeakServiceLab.ps1 -Create -TestUser $testSid
```
