...
The [Windows 11 client acceptance](docs/windows11-client-acceptance-2026-09-25.md) records a native PowerShell 5.1 UAC-to-SYSTEM proof, Resume, standard-user scans, Defender fallback, and a verified WinPEAS executable run.
