...
| CVE-2023-21768 | Windows Ancillary Function Driver for WinSock local elevation; the linked public PoC claims a narrow Windows 11 22H2 target and is unreviewed here | Consult the exact Microsoft build and update status | [Microsoft advisory](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2023-21768) |
